...
@onready var function_graph: ColorRect = $MonteCarlo
@onready var result_label: Label = $Panel/ResultLabel
@onready var points_value: Label = $Panel/Vbox/PointsValue
@onready var points_slider: HSlider = $Panel/Vbox/PointsSlider
